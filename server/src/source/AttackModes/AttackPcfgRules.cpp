/**
 * @file AttackPcfgRules.cpp
 * @brief Source file for creation of Pcfg Attack with rules
...
bool CAttackPcfgRules::makeWorkunit()
{
    ...
    DB_WORKUNIT wu;
    char name1[Config::SQL_BUF_SIZE],name2[Config::SQL_BUF_SIZE],name3[Config::SQL_BUF_SIZE],name4[Config::SQL_BUF_SIZE],
         name5[Config::SQL_BUF_SIZE],path[Config::SQL_BUF_SIZE];
    ...
    retval = create_work(
            wu,
            Config::inTemplatePathPcfgRules,
            path,
...
bool CAttackPcfgRules::generateWorkunit()
{
    Tools::printDebugHost(Config::DebugType::Log, m_job->getId(), m_host->getBoincHostId(),
